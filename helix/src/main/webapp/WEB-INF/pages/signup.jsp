<html>
  ...
  <body>
    <form action="/" class="login">
      ...
      <div class="field"><span class="fa fa-user"></span><input id = "signup-name" type="text" placeholder="User Name"></div>
      ...
      <span class="login-form-copy">Or sign up with</span>
    <span class="logn-form-copy">Already have an account? <a href="/" class="login-form__sign-up">Login</a></span>
    </form>
