               ...
               <div class="layout_wrapper">
                  ...
                  <div class="layout_content">
                     <div class="feed">
                        ...
                        <c:forEach var="memberOfRecommendationArray" items="${RECOMMENDATIONS}" >
                            <div class="feed_item">
                               <div class="joke">
                                  <div class="joke_wrapper">
                                     <div class="joke_block joke_block--header">
                                        ...
                                        <c:if test="${not memberOfRecommendationArray.is_followed}">
                                            <button class="follow-member" member-id=${memberOfRecommendationArray.id} type="submit" tabindex="0" style="margin-top: 6px;">
                                                <span tabindex="-1">Follow</span>
                                            </button>
                                        </c:if>
                                        <c:if test="${memberOfRecommendationArray.is_followed}">
